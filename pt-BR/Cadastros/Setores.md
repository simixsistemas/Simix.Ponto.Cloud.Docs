# Como cadastrar um setor no Símix Ponto
...
## Pré-requisitos
Antes de iniciar o cadastro de setor no Símix Ponto, verifique se você possui:
...
## Passo a Passo para cadastrar um setor no Símix Ponto

### 1. Acesse o cadastro de setores
Acesse o menu principal do Símix Ponto e clique em **Cadastros**.  
Em seguida, clique em **Mais Cadastros** e depois em **Setores**.
...
### 2. Inicie um novo cadastro de setor
Na tela de setores do Símix Ponto, clique no botão **Novo** para criar um novo setor.

Caso queira alterar um setor existente, clique no **ícone de lápis** correspondente ao setor desejado.  
...
### 3. Preencha os campos do cadastro de setor
No formulário de cadastro de setor do Símix Ponto, preencha corretamente os campos disponíveis.

**Descrição**  
Digite o nome do setor.  
Exemplos de descrição de setor: *Financeiro*, *Recursos Humanos*, *Produção*.

**Ativo?**  
Marque esta opção para que o setor fique disponível para seleção em outros cadastros do Símix Ponto, como no cadastro de colaboradores.  
Se essa opção estiver desmarcada, o setor não aparecerá nas listas de seleção do sistema.
...
Para acessar o cadastro de setores no Símix Ponto, utilize o seguinte caminho completo de menu:

**Cadastros > Mais Cadastros > Setores**

Todos os campos do cadastro de setor possuem descrição clara e acessível.  
As ações disponíveis nessa tela do Símix Ponto são:

• **Novo** para criar um setor.  
• **Ícone de lápis** para editar um setor existente.  
• **Seta ao lado do lápis** para excluir um setor.
...
## Exemplos de utilização do cadastro de setor

### Exemplo 1: Organização por área
Uma empresa pode cadastrar setores no Símix Ponto como:
...
### Exemplo 3: Desativação de setores antigos
...
O cadastro de setores no Símix Ponto é fundamental para manter a estrutura organizacional clara e eficiente.  
