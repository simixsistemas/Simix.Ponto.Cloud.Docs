...
# Geral
---
### Sugerir backup  após número determinado de dias
<!-- TempoBackup -->

### Bloquear período após número determinado de dias
<!-- TempoBloqPeriodo -->

### Dia início do cartão
<!-- DiaInicio -->

### Permitir dia de inicio alternativo
<!-- PermitirDiaIniAlternativo -->

### Dia início VT
<!-- DiaInicioVT -->

### Tipo de período do VT
<!-- TpPeriodoVT -->

### Ignorar data de troca no VT
<!-- IgnorarDtTrocaVT -->

### Dia de inicío do desconto do VT
<!-- DiaInicioDescVT -->

### Dia início VR
<!-- DiaInicioVR -->

### Dia de inicío do desconto do VR
<!-- DiaInicioDescVR -->

### Modelo de exibição da manutenção (8 últimos meses, mm/aaaa ou intervalo dd/mm/aaaa até dd/mm/aaaa)
<!-- ModeloMes -->
...
# Relógio
---
### Verifica o tipo de registro que é efutado por código do funcionário ou de registro
<!-- TipoRegistro -->

### Permitir mover/excluir horários
<!-- ExcluirHorario -->

### Mostrar código
<!-- MostrarCod -->

### Permitir registros pela Web para todos
<!-- PermitirRegWebTodos -->

### Carregar script no registro do ponto
<!-- CarregarScriptCalcReg -->

### Exibir foto ao registrar o ponto
<!-- ExibirFotoReg -->

### Tempo para a mensagem de código recém computado (minutos)
<!-- TempoCodRecemComputado -->
...
<!-- SireneMargemHorario1 -->

### Tempo de margem de toque (minutos) 2
<!-- SireneMargemHorario2 -->

### Porta serial (COM)
<!-- SirenePortaSerialCOM -->
